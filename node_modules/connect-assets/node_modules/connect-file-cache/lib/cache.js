...
(function() {
  ...
  ConnectFileCache = (function() {
    ...
    function ConnectFileCache(options, map) {
      ...
      if ((_ref1 = (_base1 = this.options).routePrefix) == null) {
        _base1.routePrefix = '/';
      }
    }
    ...
    ConnectFileCache.prototype.serveBuffer = function(req, res, next, _arg) {
      var cacheHash, cacheTimestamp, clientTimestamp, contentDisposition, filename, flags, route, _ref, _ref1;
      route = _arg.route;
      ...
      if (cacheHash.gzippedData && ((_ref1 = req.headers['accept-encoding']) != null ? _ref1.match(/gzip/) : void 0)) {
